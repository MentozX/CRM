        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TreatmentHistory_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TreatmentHistory_Treatments_TreatmentId",
                        column: x => x.TreatmentId,
                        principalTable: "Treatments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SmsNotifications_Reservations_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_ScheduledAtUtc",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SmsNotifications_ReservationId",
                table: "SmsNotifications",
                column: "ReservationId");

            migrationBuilder.CreateIndex(
                name: "IX_SmsNotifications_Type_ScheduledAtUtc",
                table: "SmsNotifications",
                columns: new[] { "Type", "ScheduledAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_TreatmentHistory_ClientId",
